...
def test_02_locators_and_clicks(driver, config):
    ...
    save_ui_screenshot(driver, "test_02_locators_and_clicks_navigated")
    ...
    save_ui_screenshot(driver, "test_02_locators_and_clicks_after_first_add")
    ...
    save_ui_screenshot(driver, "test_02_locators_and_clicks_after_second_add")
    ...
    save_ui_screenshot(driver, "test_02_locators_and_clicks_after_delete")
